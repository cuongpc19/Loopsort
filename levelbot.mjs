...
// Bo level GOC (co ban quyen, khong nam trong repo nay): mac dinh doc tu ban lam viec ben canh,
// doi cho bang LS_ORIG. Bo cua minh nam ngay trong `data/`.
const ORIG = path.resolve(process.env.LS_ORIG || path.resolve(HERE, "../Loop Sort/Manythings/LoopSort-teardown/data"));
